...
#define THREAD_FLAG__IO_TRANSMIT	0x00000020
#define THREAD_FLAG__IO_TXRX		(THREAD_FLAG__IO_RECEIVE | THREAD_FLAG__IO_TRANSMIT)

#define THREAD_WAIT_TYPE__SLEEP			0
#define THREAD_WAIT_TYPE__OBJECT		1
#define THREAD_WAIT_TYPE__INTERRUPT		2
